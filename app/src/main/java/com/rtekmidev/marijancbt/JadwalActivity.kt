...
import com.rtekmidev.marijancbt.api.JadwalUjian
...
class JadwalActivity : AppCompatActivity() {
    ...
    private fun ubahFilter(tipe: String, view: View) {
        ...
        for (i in cardIds.indices) {
            ...
            text.setTextColor(Color.parseColor("#2563EB"))
        }
    ...
    private fun renderJadwal(jadwalList: List<JadwalUjian>) {
        ...
        for (jadwal in jadwalList) {
            ...
            if (status == "2") {
                ...
                tvStatusBadge.setTextColor(Color.parseColor("#2563EB"))
                ...
                viewAksen.setBackgroundColor(Color.parseColor("#2563EB"))

                btnKerjakan.text = "MULAI UJIAN"
                btnKerjakan.isEnabled = true
                btnKerjakan.backgroundTintList = android.content.res.ColorStateList.valueOf(Color.parseColor("#2563EB"))
                btnKerjakan.setTextColor(Color.WHITE)
