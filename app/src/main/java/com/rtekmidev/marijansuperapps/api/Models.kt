...
data class DataRiwayat(
    ...
    val jumlah_bayar: String? = null,
    val payment_type: String?,
    val status_transaksi: String?,
    val status_tagihan: String? = null,
    val status_bayar: String? = null,
    val nominal_tagihan: String? = null,
    val nominal_terbayar: String? = null,
...
data class DataSanggahan(
    ...
    val bukti_pembayaran: com.google.gson.JsonElement? = null,
    val bukti_urls: List<String>? = null,
