...
import com.rtekmidev.marijansuperapps.api.HariJadwalData
import com.rtekmidev.marijansuperapps.api.JadwalItemModel
import com.rtekmidev.marijansuperapps.api.JadwalMengajarData
...
class JadwalMengajarActivity : AppCompatActivity() {
    ...
    private fun renderDashboard(data: JadwalMengajarData) {
        ...
        if (guru != null) {
            ...
            tvNamaSekolahBadge.text = guru.nama_sekolah ?: "MA Riyadhul Jannah"
