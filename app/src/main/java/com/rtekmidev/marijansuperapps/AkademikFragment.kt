...
import com.rtekmidev.marijansuperapps.api.DashboardData
import com.rtekmidev.marijansuperapps.api.MateriPreviewItem
import com.rtekmidev.marijansuperapps.api.TugasPreviewItem
    ...
    private fun populateMateriTerkini(
        ...
        for (item in list.take(3)) {
            ...
            if (fileType.equals("PDF", ignoreCase = true)) {
                ...
                tvBadgeFileType.setTextColor(android.graphics.Color.parseColor("#059669"))
            }
