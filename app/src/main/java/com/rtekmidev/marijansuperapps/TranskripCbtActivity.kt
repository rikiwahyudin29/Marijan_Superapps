...
import com.rtekmidev.marijansuperapps.api.JenisUjianFilterItem
import com.rtekmidev.marijansuperapps.api.NilaiCbtItem
import com.rtekmidev.marijansuperapps.api.RingkasanCbt
import com.rtekmidev.marijansuperapps.api.TahunAjaranFilterItem
import com.rtekmidev.marijansuperapps.api.TranskripCbtResponse
...
class TranskripCbtActivity : AppCompatActivity() {
    ...
    private fun renderStudentInfo(body: TranskripCbtResponse) {
        body.student_info?.let { s ->
            ...
            tvStudentJurusan.text = s.jurusan ?: "Jurusan MA Riyadhul Jannah"
