...
import com.rtekmidev.marijansuperapps.api.ProfilSiswaData
...
class ProfilFragment : Fragment(), RefreshableFragment {
    ...
    private fun initClickListeners(view: View) {
        ...
        view.findViewById<View>(R.id.btnEditFotoSiswa)?.setOnClickListener {
            Toast.makeText(
                requireContext(),
                "Foto profil siswa dapat disinkronkan melalui bagian Tata Usaha / Wali Kelas MA RJ.",
                Toast.LENGTH_LONG
            ).show()
        }
