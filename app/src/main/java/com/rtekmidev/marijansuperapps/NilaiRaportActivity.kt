...
import com.rtekmidev.marijansuperapps.api.NilaiMapel
...
class NilaiRaportActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (headerLayout != null) {
            ...
            com.rtekmidev.marijansuperapps.util.AvatarHelper.setAvatar(this, namaSiswa, fotoProfil, ivProfilPhoto, tvProfilInisial, cvProfilPic)
        }
