...
class SplashActivity : AppCompatActivity() {
    ...
    private fun checkLoginSession() {
        ...
        if (isGuruLoggedIn) {
            com.rtekmidev.smkrjsuperapps.api.ApiClient.authToken = prefGuru.getString("token", "") ?: ""
            startActivity(Intent(this, DashboardGuruActivity::class.java))
        } else if (isSiswaLoggedIn) {
            com.rtekmidev.smkrjsuperapps.api.ApiClient.authToken = prefSiswa.getString("token", "") ?: ""
