...
import com.rtekmidev.smkrjsuperapps.api.SiswaJurnal
    ...
    private fun updateButtonStyles(holder: ViewHolder, status: String?) {
        ...
        when (status?.uppercase(Locale.ROOT)) {
            ...
            "S" -> {
                ...
                holder.btnSakit.backgroundTintList = ColorStateList.valueOf(Color.parseColor("#2563EB"))
                holder.btnSakit.setTypeface(null, android.graphics.Typeface.BOLD)
                
                holder.tvStatusBadge.text = "Sakit"
                holder.tvStatusBadge.setTextColor(Color.parseColor("#1D4ED8"))
