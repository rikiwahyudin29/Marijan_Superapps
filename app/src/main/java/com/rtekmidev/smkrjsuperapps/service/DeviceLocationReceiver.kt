package com.rtekmidev.smkrjsuperapps.service
...
import com.rtekmidev.smkrjsuperapps.util.LocationHelper
...
class DeviceLocationReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_PERIODIC_UPDATE = "com.rtekmidev.smkrjsuperapps.ACTION_UPDATE_LOCATION_PERIODIC"
