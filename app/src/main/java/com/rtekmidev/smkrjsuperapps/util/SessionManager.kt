...
import com.rtekmidev.smkrjsuperapps.LoginActivity
import com.rtekmidev.smkrjsuperapps.api.ApiClient
import com.rtekmidev.smkrjsuperapps.service.DeviceLocationScheduler
...
object SessionManager {
    ...
    fun konfirmasiLogout(
        activity: Activity,
        pesan: String = "Apakah Anda yakin ingin keluar dari akun aplikasi SMK Riyadhul Jannah?"
    ) {
