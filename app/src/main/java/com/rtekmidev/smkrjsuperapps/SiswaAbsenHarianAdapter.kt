...
import com.rtekmidev.smkrjsuperapps.api.SiswaAbsenItem
    ...
    private fun updateItemUi(holder: ViewHolder, item: SiswaAbsenItem) {
        ...
        when (item.status_kehadiran) {
            ...
            "Sakit" -> {
                ...
                holder.tvStatusBadge.setTextColor(android.graphics.Color.parseColor("#2563EB"))
                holder.tvStatusBadge.backgroundTintList = android.content.res.ColorStateList.valueOf(android.graphics.Color.parseColor("#EFF6FF"))
            }
            "Izin" -> {
